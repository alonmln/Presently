...
## Hebrew
Presently: יומן תיעוד הוכרת תודה

תעדו את הרגעים הקטנים בחייכם עם Presently, אפליקציה חינמית ושומרת פרטיות לתיעוד הוכרת תודה

תעדו הוכרת יודע יומית עם האפליקציה החינמית ושומרת הפרטיות Presently

Presently אפשר:
⁕ לתעד כל יום על מה מוכירים תודה
⁕ להסתכל לאחור על רגעי הוכרת תודה בחייכם
⁕ למצוא מוטיבציה וציטוטים מעוררי השראה
⁕ להגדיר התראה יומית לתזכורת לתיעוד הוכרת תודה
⁕ להגביל גישה לרשומות עם תביעת אצבע או דפוס פנים
⁕ גיבוי אוטומית של הרשומות ל-DropBox
⁕ חיפוש ברשומות ישנות
⁕ לשתף רשומות עם משפחה וחברים
⁕ ייבוא/ייצוא של רשומות
⁕ התאמה של ערכות הנושא לבחירתם

Presently היא אפליקציה 100% חינמית וללא פרסומות. כל הרשומות שלכם נשמרות בשליטתכם על המכשיר שלכם.